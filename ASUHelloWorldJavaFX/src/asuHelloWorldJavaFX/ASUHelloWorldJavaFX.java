...
public class ASUHelloWorldJavaFX extends Application {
	...
	Scene login, signup, messaging, doctor, patient, nurse;
	...
	public void start(Stage primaryStage) {
		...
		Button createBtn = new Button("Don't Have Account? Create Account.");
		...
		@Override
			public void handle(ActionEvent event) {
				if(l.loggedIn(fName.getText(), lName.getText(), date)){
					primaryStage.setScene(new Scene(signupPage)); //here
					primaryStage.show();
		...
		createBtn.setOnAction(e -> {
		    ...
		    primaryStage.setScene(createAccountPage.createAccountScene(primaryStage));
		    primaryStage.show();
		});
		...
		loginPage.getChildren().addAll(medBridge, subTitle, labels, loginBtn,createBtn );
